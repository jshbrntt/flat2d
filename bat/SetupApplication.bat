...
:: Android packaging
set AND_CERT_NAME="BottlesMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BottlesMobile.p12
...
set IOS_PROVISION=cert\BottlesMobile.mobileprovision
...
set APP_ID=air.BottlesMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BottlesMobile
